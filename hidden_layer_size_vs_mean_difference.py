...
for hidden_layer_size in range_list:
    mlp = MLPRegressor(hidden_layer_sizes=(hidden_layer_size,), activation='relu', solver='adam', max_iter=10000)
...
plt.title('Hidden Layer Size vs. Mean of Difference')
plt.legend()
plt.show()